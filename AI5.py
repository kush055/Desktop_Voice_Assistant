...
def speak(text):
    print(text)  # Placeholder for a text-to-speech function
...
def read_email():
    ...
    try:
        ...
        # Login (Use App Passwords or OAuth2 for security)
        email_user = "your-email@gmail.com"  # Replace with your email
        email_pass = "your-app-password"  # Use App Passwords, NOT your actual password
        ...
        latest_email_id = mail_ids[-1].decode()  # Convert byte ID to string
        ...
        for response_part in data:
            if isinstance(response_part, tuple):
                ...
                break  # Stop after reading the latest email
